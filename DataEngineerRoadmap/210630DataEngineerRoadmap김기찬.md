...
* Basic Terminal usage
  * 리눅스에서 커맨드 다루는 법
* 자료구조와 알고리즘
  * 데이터를 저장하고 읽는 방법, 효율적으로 문제를 푸는 방법
* APIs
  * 서로 다른 두 애플리케이션간에 소통할 수 있도록 만들어 놓은 중간 인터페이스
* REST
  * 월드 와이드 웹과 같이 분산 하이퍼미디어 시스템을 위한 소프트웨어 아키텍처의 한 형식
...
* Data security & privacy
  ...
  * Key management
    ...
    * cryptosystem에서 crpytographic key를 관리하는 기술
* 요약
  * 굳이 데이터 분야가 아니더라도 개발하면서 알아야 할 기술들이다
  * 개발 그 자체를 하기 위한 도구들
    * 터미널 사용법, 자료구조, 알고리즘, API, REST, python, java, HTTP/HTTPS, TCP, IP, SSH, DNS, Firewalls, VPN, VPC
  * 개발 편의성, 코드 퀄리티에 도움을 주는 도구들
    * git, Containers(Docker), Container orchestration(Kubernetes, GKE), Infrastructure provisioning(Terraform, AWS CDK), CI/CD(Github Action, Jenkins)
...
* OLTP vs OLAP
  ...
  * OLAP cube 예시) sales data를 region, quarter, product에 따라 보여줌
  ...
  ![A three dimensional Diagram illustrating the layers within a OLAP Data Cube ](C:/Users/js711/Documents/tmi-study/DataEngineerRoadmap/210630DataEngineerRoadmap김기찬.assets/ICLH_Diagram_Batch_01_09-OLAP-DataCube-WHITEBG.png)
...
* Relational databases & Non-relational databases
  ...
  * Wide Column DB
    ...
    ![Image](C:/Users/js711/Documents/tmi-study/DataEngineerRoadmap/210630DataEngineerRoadmap김기찬.assets/wide column_2.png)
  ...
  * Graph DB
    ...
    ![Image](C:/Users/js711/Documents/tmi-study/DataEngineerRoadmap/210630DataEngineerRoadmap김기찬.assets/graph_1.png)
  ...
  * Key-Value DB
    ...
    ![Image](C:/Users/js711/Documents/tmi-study/DataEngineerRoadmap/210630DataEngineerRoadmap김기찬.assets/KeyValue_1.png)
...
* Messaging
  ...
  * RabbitMQ
    ...
    ![No Image](C:/Users/js711/Documents/tmi-study/DataEngineerRoadmap/210630DataEngineerRoadmap김기찬.assets/3.png)
...
* 요약
  ...
  * 전통적인 데이터베이스 설계 기술
    * Entity-Relationship model, Relational model, Normalization, Denormalization, ACID transaction, OLTP vs OLAP, Dimensional modeling, Relational databases, Data warehouse, Batch, Streaming
  * 분산 환경에서의 데이터베이스 설계 기술
    * PACELC, Horizontal vs Vertical Scaling, Non-relational databases, HDFS, MapReduce
  * 빅데이터 환경에서 필요한 관리도구
    * Messaging(RabbitMQ), Workflow scheduling(Airflow), Monitoring data pipelines(Prometheus, Datadog, Sentry)
...
* Machine Learning fundamentals
  ...
  * Terminology
    ...
    * Supervised vs unsupervised learning
      * https://www.ibm.com/cloud/blog/supervised-vs-unsupervised-learning
      * supervised learning : labeled dataset을 이용해 데이터를 분류하거나 결과를 예측하는 것
        * classification
          * 데이터를 특정 카테고리에 배치하는 알고리즘을 사용한다
          * Linear classifier, support vector machine, decision tree, random forest
        * regression
  ...
  * Tensorflow
    ...
    * Tensor(다차원의 배열)을 담고 있는 Node와 이를 다양한 연산으로 연결하고 있는 Edge로 구성되어 Tensor들이 서로 연산을 통해 값을 주고 받는 흐름(Flow)으로 작동
      ...
      ![img](C:/Users/js711/Documents/tmi-study/DataEngineerRoadmap/210630DataEngineerRoadmap김기찬.assets/img.png)
...
* 요약
  * 데이터 엔지니어가 알면 좋을 데이터 사이언티스트, 분석가가 주로 다루는 기술들
  * 데이터 시각화하는 기술
    * Tableau, Looker, Grafana, Jupyter Notebook
  * 딥러닝 관련 기술
    * Supervised vs unsupervised learning, evaluation metrics, scikit-learn, Tensorflow, Keras, PyTorch
  * 딥러닝 워크플로우 기술
